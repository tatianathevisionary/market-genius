...
_Updated 2026-06-23T02:11:31+00:00 (hourly via launchd) — framework: [SIGNALS.md](../docs/SIGNALS.md)_

## `Basing` | A: 2/4 | B: 1/3

**BTC $63,980** | 5d -0.7% | vol 0.78x avg | -10.9% vs 50d MA ($71,807)
...
|---|---|---|
| Brent | -10.9% | shock originator |
| US 10Y | +0.5% | transmission |
| DXY | +1.4% | denominator |
| Nasdaq fut | +2.6% | risk appetite |
| Gold | -0.9% | hedge competitor |
| **BTC** | **-0.7%** | subject |

Correlations (30d): BTC↔Nasdaq **-0.221** | BTC↔Gold **0.877** | BTC/Gold ratio 15.317
...
- macro_chain: 0
- rotation: 0
- _as of 2026-06-23T02:00:27+00:00_
