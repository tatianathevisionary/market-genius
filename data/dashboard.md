...
_Updated 2026-07-24T13:51:34+00:00 (hourly via launchd) — framework: [SIGNALS.md](../docs/SIGNALS.md)_

## `Basing` | A: 0/4 | B: 0/3

**BTC $64,079** | 5d -0.9% | vol 0.93x avg | +1.5% vs 50d MA ($63,107)
...
| US 10Y | +3.2% | transmission |
| DXY | +0.7% | denominator |
| Nasdaq fut | -1.0% | risk appetite |
| Gold | +1.1% | hedge competitor |
| **BTC** | **-0.9%** | subject |

Correlations (30d): BTC↔Nasdaq **-0.251** | BTC↔Gold **0.401** | BTC/Gold ratio 15.798
...
- macro_chain: 0
- rotation: 0
- _as of 2026-07-24T12:24:59+00:00_
