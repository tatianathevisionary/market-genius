...
_Updated 2026-08-20T01:50:02+00:00 (hourly via launchd) — framework: [SIGNALS.md](../docs/SIGNALS.md)_

## `Trending` | A: 3/4 | B: 1/3

**BTC $69,800** | 5d +10.8% | vol 2.22x avg | +9.1% vs 50d MA ($63,984)
...
|---|---|---|
| Brent | +3.4% | shock originator |
| US 10Y | -0.6% | transmission |
| DXY | -1.2% | denominator |
| Nasdaq fut | -0.7% | risk appetite |
| Gold | +3.3% | hedge competitor |
| **BTC** | **+10.8%** | subject |

Correlations (30d): BTC↔Nasdaq **0.051** | BTC↔Gold **0.284** | BTC/Gold ratio 15.332
...
- macro_chain: 0
- rotation: 0
- _as of 2026-08-20T01:32:09+00:00_
