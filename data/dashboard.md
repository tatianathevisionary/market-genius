...
_Updated 2026-09-03T11:58:17+00:00 (hourly via launchd) — framework: [SIGNALS.md](../docs/SIGNALS.md)_

## `Basing` | A: 0/4 | B: 0/3

**BTC $77,943** | 5d -0.4% | vol 0.89x avg | +14.0% vs 50d MA ($68,392)
...
|---|---|---|
| Brent | +8.4% | shock originator |
| US 10Y | +2.8% | transmission |
| DXY | +0.0% | denominator |
| Nasdaq fut | -2.0% | risk appetite |
| Gold | -2.7% | hedge competitor |
| **BTC** | **-0.4%** | subject |

Correlations (30d): BTC↔Nasdaq **0.102** | BTC↔Gold **0.736** | BTC/Gold ratio 17.385
...
- macro_chain: 0
- rotation: 0
- _as of 2026-09-03T11:49:40+00:00_
