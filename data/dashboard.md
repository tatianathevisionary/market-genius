...
_Updated 2026-07-03T07:37:47+00:00 (hourly via launchd) — framework: [SIGNALS.md](../docs/SIGNALS.md)_

## `Trending` | A: 3/4 | B: 1/3

**BTC $61,678** | 5d +3.6% | vol 1.13x avg | -8.4% vs 50d MA ($67,347)

## Macro chain (5-day moves)

| Series | 5d % | Chain role |
|---|---|---|
| Brent | -0.3% | shock originator |
| US 10Y | -1.8% | transmission |
| DXY | -0.7% | denominator |
| Nasdaq fut | +1.7% | risk appetite |
| Gold | +2.7% | hedge competitor |
| **BTC** | **+3.6%** | subject |

Correlations (30d): BTC↔Nasdaq **0.219** | BTC↔Gold **0.828** | BTC/Gold ratio 14.731
...
- macro_chain: 0
- rotation: 0
- _as of 2026-07-03T07:33:41+00:00_
